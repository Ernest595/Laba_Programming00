...
#define _CRT_SECURE_NO_WARNINGS 4 
#define SIZE 10
typedef int tvalue;
...
int main() {
    ...
    tvalue matrix_data[SIZE][SIZE] = {
        {1,  2,  67,  40,  50,  6,  7,  80,  90,  10},
        {10,  9,  1,  10,  10,  1, 10,  10,  10,  10},
        {5,   1,  15,  2,  5,  3,  35,  40,  45,  50},
        {344,  2,  30,  35,  40,  4,  90,  5,  60,  65}, 
        {1,   3,  5,   7,   9,   1,  13,  15,  17,  19},
        {10, 9,  60,  4,  20,  7,  20,  40,  60,  3},
        {10,  2,  30,  4,  50,  6,  70,  80,  9,  10},
        {5,   1,  25,  35,  45,  5,  65,  75,  85,  95},
        {0,   -1, -2, -30, 16, -5, 60, 7, -80, 90},
        {25,  3,  35,  40,  5,  5,  55,  60,  65,  70}
    };
