...
int Find_Kaprekara(int base, ...) {
	...
	while ((ptr = va_arg(args, char*)) != NULL) {
		...
		ans = NULL;
		decimal = 0;
		convert_decimal(ptr, base, &decimal);
